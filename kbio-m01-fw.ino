...
#define BUILD_INFORMATION "acasajus-f122345"
#endif
...
KEYMAPS(
  ...
  (Key_Escape,     Key_1, Key_2, Key_3, Key_4, Key_5, Key_LEDEffectNext,
   ...
   Key_Backtick,   Key_Z, Key_X, Key_C, Key_V, Key_B, Key_Escape,
   Key_LeftGui, Key_Backspace, Key_LeftControl, Key_LeftShift,
   ShiftToLayer(FUNCTION),

   Key_Tab,  Key_6, Key_7, Key_8,     Key_9,         Key_0,         LockLayer(NUMPAD),
...
#error "No default keymap defined. You should make sure that you have a line like '#define PRIMARY_KEYMAP_QWERTY' in your sketch"
  ...
  [FUNCTION] =  KEYMAP_STACKED
   (___, Key_F1,     Key_F2,           Key_F3,           Key_F4,          Key_F5,            XXX,
    XXX, XXX,        Key_mouseWarpNW,  Key_mouseUp,      Key_mouseWarpNE, Key_mouseScrollUp, Key_mouseWarpEnd,
    XXX, XXX,        Key_mouseL,       Key_mouseDn,      Key_mouseR,      Key_mouseScrollDn,
    ___, XXX,        Key_mouseWarpSW,  Key_mouseWarpEnd, Key_mouseWarpSE, XXX,               Key_mouseBtnL,
